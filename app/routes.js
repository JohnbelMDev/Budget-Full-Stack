...
// message board routes ===============================================================
    ...
    app.post('/addclass', (req, res) => {
      ...
      // defining name
      db.collection('expence').save({name: req.body.id, class: req.body.class}, (err, result) => {
        if (err) return console.log(err)
